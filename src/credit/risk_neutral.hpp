 ...
 * Description
 * -----------
 * Calculate the vanilla option price via the Black-Scholes equation, using the provided inputs:
 *
 * Params
 * ------
 * double S0:          Current price of underlying
 ...
 * Returns
 * -------
 * std::tuple<double, double, double>, split into the following:
 ...
 * Returns
 * -------
 * std::tuple<double, double>, split into the following:
 ...
 * Description
 * -----------
 * Converts a given actual probability vector into risk-adjusted probability.
 * The Wang Transform is one such method of doing so, and uses the Sharpe Ratio to do so.
 *
 * Params
 * ------
 * std::vector<double> P:      Input vector of probabilities
 ...
 * Description
 * -----------
 * Calculate risk-neutral probability of default under Merton model
 *
 * Params
 * ------
 ...
 * Params
 * ------
 * double y:           Original target investment rate (yield)
 ...
 * Params
 * ------
 * double in_price:        Price of instrument to convert
 * double rf:              Risk-free interest rate
